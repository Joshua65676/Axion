          ...
          <section className="flex flex-row gap-10">
            <div className="flex flex-col w-[313px] h-[143px] border border-UnreadText rounded-3xl p-[20px] gap-3 bg-UnreadBg">
              <div className="flex flex-row gap-[3px]">
                ...
                <span className="text-[12px] font-normal leading-[125%] tracking-[-0.5%] text-UnreadText">Unread</span>
              </div>
              <span className="text-[32px] font-normal leading-[100%] tracking-[-0.5%] text-Black">0</span>
            </div>
            ...
            <div className="flex flex-col w-[313px] h-[143px] border border-BookmarkText rounded-3xl p-[20px] gap-3 bg-BookmarkBg">
              <div className="flex flex-row gap-[3px]">
                ...
                <span className="text-[14px] font-normal leading-[125%] tracking-[-0.5%] text-BookmarkText">Bookmarks</span>
              </div>
              <span className="text-[32px] font-normal leading-[100%] tracking-[-0.5%] text-Black">0</span>
            </div>
          </section>
