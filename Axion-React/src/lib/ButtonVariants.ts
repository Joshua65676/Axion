...
export const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "text-[14px] leading-[13.7px] bg-white borde border-black text-black font-blacknorthdemo shadow hover:bg-white/90",
        yellow: "text-[14px] leading-[19.2px] bg-secondary borde border-black text-black font-bold shadow hover:bg-secondary/90",
